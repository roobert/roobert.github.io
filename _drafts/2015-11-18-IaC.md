...
This example will use OpenStack as the deployment platform, but with minimal effort it should be possible to modify the terraform and packer templates to work with any of their providers, e.g: AWS.
